...
const phone = require('./images/ask.png');
const sms = require('./images/ask.png');
const weibo = require('./images/ask.png');
const weixin = require('./images/ask.png');

var uploadedDataURL = require("./images/data-1479697763933-ByhDrJlGx.json");


export default function MyChart() {
  echarts.registerMap('wuhan', uploadedDataURL);
 var geoCoordMap = {
        ...
        title: {
            ...
            series: [{
                ...
                data: [{
                    ...
                    coords: [geoCoordMap['微信'], geoCoordMap['武汉交管局']]
                }, {

                    coords: [geoCoordMap['微博'], geoCoordMap['武汉交管局']]
                }, {

                    coords: [geoCoordMap['热线'], geoCoordMap['武汉交管局']]
                }, {

                    coords: [geoCoordMap['短信'], geoCoordMap['武汉交管局']]
                }]
            }, {
                ...
                data: [
                {
                    ...
                    name: '热线',
                    value: geoCoordMap['热线'].concat(data.热线),
                    ...
                    name: '短信',
                    value: geoCoordMap['短信'].concat(data.短信),
                    ...
                    name: '武汉交管局',
                    value: geoCoordMap['武汉交管局'].concat(parseInt(data.微信) + parseInt(data.微博) + parseInt(data.热线) + parseInt(data.短信)),
                    itemStyle: {
                        normal: {
                            color: '#ffffff',
                            borderColor: '#000'
